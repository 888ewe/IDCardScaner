...
import cn.edu.zafu.camera.IActivityLifiCycle;
import cn.edu.zafu.camera.MyApplication;
...
public class SensorControler implements IActivityLifiCycle, SensorEventListener {
    ...
    private SensorControler() {
        mSensorManager = (SensorManager) MyApplication.CONTEXT.getSystemService(Activity.SENSOR_SERVICE);
